...
export const DoFCharacters: IDoFCharacterConfigs = {
    characters: [
        // Pre-6
        DoFPlayable[DoFCharKey.Rena],
        DoFPlayable[DoFCharKey.Garath],
        DoFPlayable[DoFCharKey.Kolbane],
        DoFPlayable[DoFCharKey.Asher],
        DoFPlayable[DoFCharKey.Eilene],
        DoFPlayable[DoFCharKey.Amelia],
        DoFPlayable[DoFCharKey.Tricia],
        DoFPlayable[DoFCharKey.Chester],
        DoFPlayable[DoFCharKey.Cathale],
        DoFPlayable[DoFCharKey.Crowe],
        DoFPlayable[DoFCharKey.Lizaveta],
        DoFPlayable[DoFCharKey.Driscoll],
        DoFPlayable[DoFCharKey.Cothiva],
        DoFPlayable[DoFCharKey.Gabriel],
        DoFPlayable[DoFCharKey.Ioan],
        DoFPlayable[DoFCharKey.Marie],
        DoFPlayable[DoFCharKey.Arcus],
        DoFPlayable[DoFCharKey.Alexis],
        DoFPlayable[DoFCharKey.Seren],
        DoFPlayable[DoFCharKey.Franceza],
        DoFPlayable[DoFCharKey.seMori],
        DoFPlayable[DoFCharKey.Sileth],
        DoFPlayable[DoFCharKey.Conleth],
        DoFPlayable[DoFCharKey.Lyndra],
        DoFPlayable[DoFCharKey.Blixa],
        DoFPlayable[DoFCharKey.Kahn],
        DoFPlayable[DoFCharKey.Wren],
        DoFPlayable[DoFCharKey.Bellona],
        DoFPlayable[DoFCharKey.Jolyon],
        DoFPlayable[DoFCharKey.Florent],
        DoFPlayable[DoFCharKey.Marin],
        DoFPlayable[DoFCharKey.Leda],
        DoFPlayable[DoFCharKey.Nari],
        DoFPlayable[DoFCharKey.Baldur],
        DoFPlayable[DoFCharKey.Nikita],
        DoFPlayable[DoFCharKey.Annelise],
        DoFPlayable[DoFCharKey.Riva],
        DoFPlayable[DoFCharKey.byorDal],
        DoFPlayable[DoFCharKey.Meliza],
        DoFPlayable[DoFCharKey.viShen],
        DoFPlayable[DoFCharKey.Corbeau],
        DoFPlayable[DoFCharKey.Brill],
        DoFPlayable[DoFCharKey.Eudira],
        DoFPlayable[DoFCharKey.Severin],
        DoFPlayable[DoFCharKey.Stolypin],
        DoFPlayable[DoFCharKey.Jauger],
        DoFPlayable[DoFCharKey.Saskia],
        DoFPlayable[DoFCharKey.Hereward],
        DoFPlayable[DoFCharKey.Dismas],
        DoFPlayable[DoFCharKey.Artemisia],
        DoFPlayable[DoFCharKey.Odette],
        DoFPlayable[DoFCharKey.Thyra],
        DoFPlayable[DoFCharKey.Adalheid],
        DoFPlayable[DoFCharKey.Sheila],
        DoFPlayable[DoFCharKey.Vincent],
        DoFPlayable[DoFCharKey.Morwen],
        DoFPlayable[DoFCharKey.Kai],
        DoFPlayable[DoFCharKey.Claudiya],
        DoFPlayable[DoFCharKey.Dahlia],
        DoFPlayable[DoFCharKey.Volund],
        DoFPlayable[DoFCharKey.Ironside],
        {
            name: 'cobbet',
