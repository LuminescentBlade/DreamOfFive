...
export const DoFPromotedClasses = {
    ...
    [DoFClasses.Bishop]: {
        ...
        caps: { hp: 60, pow: 26, skl: 26, spd: 28, luk: 30, def: 15, res: 30, con: 20 }
    },
    ...
    [DoFClasses.Valkyrie]: {
        ...
        caps: { hp: 60, pow: 27, skl: 29, spd: 28, luk: 30, def: 15, res: 29, con: 20 }
    },
    [DoFClasses.Sibyl]: {
    ...
    [DoFClasses.Sage]: {
        promo: { hp: 4, pow: 2, skl: 3, spd: 2, luk: 0, def: 3, res: 3, con: 1 },
        caps: { hp: 60, pow: 27, skl: 30, spd: 27, luk: 30, def: 15, res: 28, con: 20 }
    },
    [DoFClasses.Sorcerer]: {
        promo: { hp: 5, pow: 3, skl: 3, spd: 1, luk: 0, def: 2, res: 3, con: 2 },
        caps: { hp: 60, pow: 30, skl: 28, spd: 25, luk: 30, def: 15, res: 29, con: 20 }
    },
    ...
    [DoFClasses.Harrier]: {
        promo: { hp: 0, pow: 0, skl: 0, spd: 0, luk: 0, def: 0, res: 0, con: 0 },
        caps: { hp: 60, pow: 26, skl: 27, spd: 28, luk: 30, def: 15, res: 25, con: 20 }
    },
