...
import { Sileth } from "./sileth.config.ts";
...
export const DoFPlayable =  {
    ...
    [DoFCharKey.Chester]: Chester,
    [DoFCharKey.Cathale]: Cathale,
    [DoFCharKey.Crowe]: Crowe,
    [DoFCharKey.Lizaveta]: Lizaveta,
    [DoFCharKey.Driscoll]: Driscoll,
    [DoFCharKey.Cothiva]: Cothiva,
    [DoFCharKey.Gabriel]: Gabriel,
    [DoFCharKey.Ioan]: Ioan,
    [DoFCharKey.Marie]: Marie,
    ...
    [DoFCharKey.Lyndra]: Lyndra,
    [DoFCharKey.Blixa]: Blixa,
    [DoFCharKey.Kahn]: Kahn,
    [DoFCharKey.Wren]: Wren,
    [DoFCharKey.Bellona]: Bellona,
    [DoFCharKey.Jolyon]: Jolyon,
    [DoFCharKey.Florent]: Florent,
    [DoFCharKey.Marin]: Marin,
    [DoFCharKey.Leda]: Leda,
    [DoFCharKey.Nari]: Nari,
    ...
    [DoFCharKey.Corbeau]: Corbeau,
    [DoFCharKey.Brill]: Brill,
    [DoFCharKey.Eudira]: Eudira,
    [DoFCharKey.Severin]: Severin,
    [DoFCharKey.Stolypin]: Stolypin,
    [DoFCharKey.Jauger]: Jauger,
    [DoFCharKey.Saskia]: Saskia,
    [DoFCharKey.Hereward]: Hereward,
    [DoFCharKey.Dismas]: Dismas,
    [DoFCharKey.Artemisia]: Artemisia,
    [DoFCharKey.Odette]: Odette,
